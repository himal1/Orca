...
//  Base Class
//----------------------------------------------------------------
@implementation ORRaspberryPiCmd
...
- (void) logResult:(id)result code:(int)aCode delegate:(ORRaspberryPiModel*)delegate
{
...
//  Delete Bucket
//----------------------------------------------------------------
@implementation ORRaspberryPiDeleteBucket
...
//  List Buckets
//----------------------------------------------------------------
@implementation ORRaspberryPiListBuckets
...
//  Delay
//----------------------------------------------------------------
@implementation ORRaspberryPiDelayCmd
+ (ORRaspberryPiDelayCmd*) delay:(int)aSeconds
{
...
//  List Orgs
//----------------------------------------------------------------
@implementation ORRaspberryPiListOrgs
...
//  Create Bucket
//----------------------------------------------------------------
@implementation ORRaspberryPiCreateBucket
...
//  Measurements
//----------------------------------------------------------------
@implementation ORRaspberryPiMeasurement
...
@implementation ORRaspberryPiCmdLineMode
...
//  Delete Data
//----------------------------------------------------------------
@implementation ORRaspberryPiDeleteAllData

+ (ORRaspberryPiDeleteAllData*) inFluxDBDeleteAllData:(NSString*)aName org:(NSString*)anOrg  start:(NSString*)aStart  stop:(NSString*)aStop
{
...
//----------------------------------------------------------------
@implementation ORRaspberryPiDeleteSelectedData

+ (ORRaspberryPiDeleteSelectedData*) deleteSelectedData:(NSString*)aName org:(NSString*)anOrg  start:(NSString*)aStart stop:(NSString*)aStop  predicate:(NSString*)aPredicate
{
